...
git clone https://github.com/jsbowen79/cloudifyrides-infra.git

ls -l /home/ubuntu/cloudifyrides-infra/k8s >> /var/log/user-data.log

# Enable Pod Security
kubectl create namespace cloudifyrides
kubectl label namespace cloudifyrides pod-security.kubernetes.io/enforce=restricted pod-security.kubernetes.io/enforce-version=latest
